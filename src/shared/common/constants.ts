...
export const ERROR_MESSAGES = {
  ...
  CATEGORY_NOT_FOUND: 'The category can not be found',
  TEST_NOT_FOUND: 'The test can not be found',
  QUESTION_IS_EMPTY: 'Question must not be empty',
  USER_NOT_FOUND: 'This user is not existed, please try again',
  DUPLICATE_CATEGORY: 'The name of category is duplicated, please try another name',
  LEVEL_NOT_FOUND: "Level can't be found",
  JOB_NOT_FOUND: "Job can't be found",
  GROUP_NOT_FOUND: "Group can't be found",
  GROUP_CAN_NOT_DELETE: 'Can not delete this group, please check relation with test',
